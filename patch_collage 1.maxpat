...
,
					...
					"patching_rect" : [ 576.0, 333.0, 150.0, 30.0 ],
					"style" : ""
				}
...
,
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"patching_rect" : [ 376.299927, 333.0, 150.0, 30.0 ],
					"style" : ""
				}
...
,
					...
					"numoutlets" : 5,
					"outlettype" : [ "signal", "signal", "signal", "", "dictionary" ],
					"patching_rect" : [ 197.0, 333.0, 150.0, 30.0 ],
					"style" : ""
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 529.299927, 566.799988, 148.0, 116.0 ],
					"varname" : "bp.Stereo[1]",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 0,
					"offset" : [ 0.0, 0.0 ],
					"patching_rect" : [ 222.0, 910.0, 221.199997, 208.399994 ],
					"prototypename" : "pixl",
					"varname" : "viewr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 222.099976, 771.0, 388.0, 130.0 ],
					"prototypename" : "pixl",
					"varname" : "mappr",
					"viewvisibility" : 1
				}
...
, 			{
				"box" : 				{
					...
					"offset" : [ 0.0, 0.0 ],
					"outlettype" : [ "" ],
					"patching_rect" : [ 222.099976, 561.0, 268.0, 198.0 ],
					"prototypename" : "pixl",
					"varname" : "patternizr",
					"viewvisibility" : 1
				}
...
,
					"patching_rect" : [ 395.299927, 509.0, 112.0, 35.0 ],
...
,
					"patching_rect" : [ 256.499878, 503.0, 96.0, 35.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 297.099976, 242.233322, 24.0, 24.0 ],
					"style" : ""
				}
...
, 			{
		...
		"parameters" : 		{
			...
			"obj-22::obj-25" : [ "SpectraLFOShape[7]", "Shape", 0 ],
			...
			"obj-22::obj-53" : [ "V rotation", "V rotation", 0 ],
			"obj-22::obj-34" : [ "H zoom", "H zoom", 0 ],
			"obj-20::obj-1" : [ "multislider[1]", "multislider", 0 ],
			"obj-20::obj-113" : [ "pictctrl[163]", "pictctrl[1]", 0 ],
			"obj-22::obj-32" : [ "range", "range", 0 ],
			...
			"obj-22::obj-71" : [ "pictctrl[4]", "pictctrl[1]", 0 ],
			"obj-20::obj-22" : [ "speed[4]", "speed", 0 ],
			"obj-21::obj-35" : [ "umenu[18]", "umenu", 0 ],
			"obj-22::obj-19" : [ "pictctrl[5]", "pictctrl[1]", 0 ],
			"obj-21::obj-53" : [ "pictctrl[21]", "pictctrl", 0 ],
			"obj-18::obj-56" : [ "OutputChannel[1]", "OutputChannel", 0 ],
			"obj-18::obj-55" : [ "DSP[1]", "DSP", 0 ],
			"obj-22::obj-82" : [ "Vzoom", "V zoom", 0 ],
			"obj-18::obj-52" : [ "Level[1]", "Level", 0 ],
			"obj-22::obj-48" : [ "rotation[2]", "rotation", 0 ],
			"obj-22::obj-51" : [ "pictctrl[3]", "pictctrl[1]", 0 ],
			"obj-22::obj-11" : [ "umenu[2]", "umenu", 0 ],
			...
			"obj-22::obj-105" : [ "FreqMode[4]", "FreqMode", 0 ],
			"obj-21::obj-1" : [ "range[6]", "range", 0 ],
			"obj-22::obj-84" : [ "V zoom", "V zoom", 0 ],
			"obj-22::obj-121" : [ "x offset[1]", "x offset", 0 ],
			"obj-22::obj-49" : [ "H rotation", "H rotation", 0 ],
			"obj-20::obj-7" : [ "live.toggle", "live.toggle", 0 ],
			"obj-22::obj-104" : [ "pictctrl[9]", "pictctrl[1]", 0 ]
		}
,
		"dependency_cache" : [ 			{
				"name" : "vz.cyclr.maxpat",
				"bootpath" : "~/Desktop/MAX-master/lesson Sound Collage, 1/patchers",
				"patcherrelativepath" : "./MAX-master/lesson Sound Collage, 1/patchers",
				"type" : "JSON",
				"implicit" : 1
			}
, 			{
